...
const portfolioConfigItems: PortfolioConfig.Items = [
    // CODE
    {
        ...
        shortDescription: 'В качестве удалённого сотрудника в течение 9 месяцев делал клиентскую часть информационной системы. Первые 3 месяца код писал на JavaScript, затем решили перейти на TypeScript. Не могу показать ни внешний вид, ни код из-за Соглашения о неразглашения.',
        tags: ['React', 'Redux', 'Hooks', 'TypeScript', 'Git Flow', 'WebSocket', 'Storybook'],
        description: [
            {
                type: 'text',
                text: 'ФЁТ,а не Фет!!"Культурная" столица мира...Кстати, сюжет о Петербурге гадкий Шизопутёнок запретил со второго сезона,т.к. его попалили на сраче в подъездах'
            },
            {
                type: 'image',
                images: [
    ...
    /*{
        ...
        portfolioLink: 'form-constructor',
        shortDescription: 'Short description',
    },*/
    /*{
        set: 'code',
        category: 'React',
        title: 'Список файлов и папок с перетаскиваемыми элементами',
        portfolioLink: 'file-manager',
        shortDescription: 'Short description',
    },*/
    /*{
        set: 'code',
